...
class TenthViewController: UIViewController {
    ...
    @IBAction func goGoGo(_ sender: Any) {
        self.performSegue(withIdentifier: "keepGoing1", sender: self)
    }
    
    @IBAction func backOneOne(_ sender: Any) {
        self.performSegue(withIdentifier: "broBringItBack", sender: self)
    }
